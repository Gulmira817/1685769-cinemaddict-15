...
import { Pages, CurrentType, UserLevel } from '../constants/constants.js';
import { getNumberFilmsGenre, getSortGenresFilms, completedFimsInDateRange } from '../utils/card.js';
...
export default class Statistic extends Smart {
  ...
  init(filmsModel) {
    ...
    this._sortGenres = null;
    this._data = {
      films: this._filmsModel.getCards(),
  ...
  _dateChangeHandler(evt) {
    ...
    switch (evt.target.value) {
      case CurrentType.ALL:
        this._getWatchedFilms(this._filmsModel.getCards());
      ...
      case CurrentType.TODAY:
        this._sortFilms = completedFimsInDateRange(this._filmsModel.getCards(), this._today, this._endToday, 'hour minute');
      ...
      case CurrentType.WEEK:
        this._sortFilms = completedFimsInDateRange(this._filmsModel.getCards(), this._week, this._endToday, 'month day');
        this._getWatchedFilms(this._sortFilms);
      ...
      case CurrentType.MONTH:
        this._sortFilms = completedFimsInDateRange(this._filmsModel.getCards(), this._lastMonth, this._endToday, 'month day');
        this._getWatchedFilms(this._sortFilms);
        this.updateData(Object.assign({}, this._data,
          {
      ...
      case CurrentType.YEAR:
        this._sortFilms = completedFimsInDateRange(this._filmsModel.getCards(), this._lastYear, this._endToday, 'year month day');
        this._getWatchedFilms(this._sortFilms);
        this.updateData(Object.assign({}, this._data,
          {
